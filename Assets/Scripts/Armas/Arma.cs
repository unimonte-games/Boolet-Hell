...
public class Arma : MonoBehaviour
{
    ...
    void Atirar()
    {
        GameObject novoTiro = Instantiate<GameObject>(projetil, origemTiro.position, origemTiro.rotation);
        Rigidbody novoTiro_rb = novoTiro.GetComponent<Rigidbody>();
        novoTiro_rb.AddForce(novoTiro.transform.forward * forcaTiro, ForceMode.Impulse);
    }
}
